...
<div class="imgAndInfo">
    ...
    <div class="imgInimgAndInfo">
        <img src="${pageContext.request.contextPath}/img/productSingle/${p.productImage.id}.jpg" class="bigImg">
        <div class="smallImageDiv">
            <c:forEach items="${p.productSingleImages}" var="pi">
                <img src="${pageContext.request.contextPath}/img/productSingle_small/${pi.id}.jpg" bigImageURL="img/productSingle/${pi.id}.jpg" class="smallImage">
            </c:forEach>
        </div>
